package com.infnet.tique.model.transiente;

import java.io.Serializable;

/**
 * Classe transiente para controlar o filtro que vem do cliente. tomar como base
 * o seguinte esquema para criar as condições de filtro (filter conditions)
